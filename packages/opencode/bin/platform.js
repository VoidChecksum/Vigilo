 ...
 * @returns {string} Package name like "vigilo-darwin-arm64"
 ...
 * @returns {string} Relative path like "vigilo-darwin-arm64/bin/vigilo"
 */
export function getBinaryPath(pkg, platform) {
  const ext = platform === "win32" ? ".exe" : "";
  return `${pkg}/bin/vigilo${ext}`;
}
